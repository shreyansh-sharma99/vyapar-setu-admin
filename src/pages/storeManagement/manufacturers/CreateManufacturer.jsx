...
export default function CreateManufacturer() {
  ...
  const { loading, error, success } = useSelector((state) => state.manufacturer);
      ...
      >
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          <div className="grid grid-cols-1 gap-4">
            <div>
              <Label htmlFor="name">Manufacturer Name<span className="text-red-500">*</span></Label>
              <Input
                id="name"
                type="text"
